...
{
    public struct CommandBufferRecorder
    {
        ...
        public void DynamicViewport(uint firstViewport, Span<VkViewport> viewports)
        {
            unsafe
            {
        ...
        public void DynamicScissors(uint firstScissor, Span<VkRect2D> scissors)
        {
            unsafe
            {
        ...
        /// <param name="dest">is the destination buffer.</param>
        /// <param name="region">is a pointer to an array of <see cref="VkBufferCopy"/> structures specifying the regions to copy.</param>
        public void CopyBuffer(Buffer src, Buffer dest, Span<VkBufferCopy> region)
        {
        ...
        public void BindDescriptorSets(Pipeline pipeline, uint firstSet,
        ...
        /// <returns>this</returns>
        public void BindVertexBuffers(uint firstBinding, Buffer[] pBuffers, Span<ulong> pOffsets)
        {
